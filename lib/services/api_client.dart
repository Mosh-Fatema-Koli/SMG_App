...
class ApiClient extends GetxService {
  ...
  static Future<Response> postData(String uri, dynamic body,
    ...
    deviceToken = await PrefsHelper.getString(AppConstant.deviceToken);
     uuid = await PrefsHelper.getString(AppConstant.userId);
     sessionToken = await PrefsHelper.getString(AppConstant.sessionToken);
    ...
    try {
      ...
      http.Response response = await client
          .post(
            Uri.parse(NewApiConstant.appBaseUrl+uri),
            body:body,
